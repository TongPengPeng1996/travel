...
<div class="header">
	<div class="container">
		<div class="header-main">
			  <div class="logo">
			  	<h1><a href="/index.php/Home/Single/../index.html">Wandering</a></h1>
			  </div>
        </div>
	</div>
</div>			
    ...
    <div class="container">
      <div class="navg-main">
		 <div class="top-nav">
			...
			<ul class="res">
				<li><a href="/index.php/Home/Single/../index.html" class="active">主页</a></li>
		 ...
		 <div class="single">
			...
			<div class="col-md-8 ">
				<div class=" single-grid">
					<img class="img-responsive" src="/Public/images/blog.jpg" alt=""  class="img-responsive">
					<div class="lone-line">
				...
				<div class="single-left ">					
					...
					<a href="single.html"><img class="img-responsive " src="/Public/images/s1.jpg" alt=""></a>
						<h6><a href="single.html">Duis autem</a></h6>
						<p>Lorem ipsum dolor sit amet, consectetuer.</p>
					</div>
					<div class="col-md-3 post-top">
					<a href="single.html"><img class="img-responsive " src="/Public/images/s2.jpg" alt=""></a>
						<h6><a href="single.html">Duis autem</a></h6>
						<p>Lorem ipsum dolor sit amet, consectetuer.</p>
					</div>
					<div class="col-md-3 post-top">
					<a href="single.html"><img class="img-responsive " src="/Public/images/s3.jpg" alt=""></a>
						<h6><a href="single.html">Duis autem</a></h6>
						<p>Lorem ipsum dolor sit amet, consectetuer.</p>
					</div>
					<div class="col-md-3 post-top">
					<a href="single.html"><img class="img-responsive " src="/Public/images/s4.jpg" alt=""></a>
						<h6><a href="single.html">Duis autem</a></h6>
						<p>Lorem ipsum dolor sit amet, consectetuer.</p>
					</div>
					<div class="clearfix"> </div>
...
<div class="copyright">
	<div class="container">
	   <div class="copy-main">
			<p>Copyright &copy; 2015.Company name All rights reserved.<a target="_blank" href="http://travel.com">Travel</a></p>
	   </div>
	   <script type="text/javascript">
